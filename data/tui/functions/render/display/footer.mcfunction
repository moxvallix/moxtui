...
data modify storage tui:private border.left append from storage tui:page border.bottom.left
...
data modify storage tui:private border.right append from storage tui:page border.bottom.right
